...
const style = {
 ...
 class Report_incident extends Component {
...
let formatted_endDate = this.state.endDate.getFullYear() + "-"
   ...
   for (let i = 0; i < this.state.getrequest.length; i++) {
     ...
     for(let i = 0; i < reportfilter.length; i++){
       ...
       console.log(reportfilter.incident_status);

       if(reportfilter[i].incident_status == "4"){

         access.push(reportfilter);

       }else if(reportfilter[i].incident_status == "3"){

         confirm.push(reportfilter);

       }else if(reportfilter[i].incident_status == "2"){

         workaround.push(reportfilter);

       }else if(reportfilter[i].incident_status == "1"){
 ...
 componentWillMount () {
   axios.get('/api/queryincident').then(response => {
     this.setState({
