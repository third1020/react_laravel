...
let container;
    ...
    class Update_news_type extends Component {
      constructor (props) {
        super(props)
        this.state = {
          type_name	: '',
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/news_type_update/${this.props.id}`, insertdata)
          .then(response => {
      ...
      componentWillMount () {
        ...
        axios.get(`/api/news_type/${this.props.id}`).then(response => {
          this.setState({
                  ...
                  <div className='card-body'>
                    <form onSubmit={this.handleCreate}>
                      <div className='form-group'>
                        <label htmlFor='type_name'>ชื่อประเภทข่าว</label>
                        <input
                          id='type_name'
                          name='type_name'
                          className={`form-control ${this.hasErrorFor('type_name') ? 'is-invalid' : ''}`}
                          placeholder="กรอกชื่อประเภทข่าว"
                          type='text'
    ...
    Update_news_type.propTypes = {
      id: PropTypes.number,

    };

    export default Update_news_type
