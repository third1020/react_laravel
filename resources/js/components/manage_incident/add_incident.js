...
let container;
    ...
    this.setState({
      ...
      handleCreate (event) {
        ...
        axios.post('/api/incident', insertdata)
          .then(response => {
                    ...
                    <form onSubmit={this.handleCreate}>
                      ...
                      <div class="input-group mb-3">
                        ...
                        {  this.state.equipment_id == '' ? (
                            <label class="input-group-text" style={{width:'190',color:'red'}}for="inputGroupSelect01" >เลือกชื่ออุปกรณ์</label>

                        ):<label class="input-group-text" style={{width:'190'}}for="inputGroupSelect01">อุปกรณ์ชื่อ</label>}
                         </div>
