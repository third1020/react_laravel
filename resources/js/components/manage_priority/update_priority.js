...
let container;
    ...
    class Update_priority extends Component {
      constructor (props) {
        super(props)
        this.state = {
          priority_name	: '',
   ...
   this.setState({priority_status: value});
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/priority_update/${this.props.id}`, insertdata)
          .then(response => {
      ...
      componentWillMount () {
        ...
        axios.get(`/api/priority/${this.props.id}`).then(response => {
          this.setState({

            priority_name	:response.data[0].type_name,
            priority_status: response.data[0].type_name
    ...
    Update_priority.propTypes = {
      id: PropTypes.number,

    };

    export default Update_priority
