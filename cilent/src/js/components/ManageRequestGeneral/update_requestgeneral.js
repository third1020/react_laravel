...
var dateTime = date+' '+time;
    ...
    class Update_RequestGeneral extends Component {
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/requestgeneral/update/${this.props.match.params.id}`, insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
    ...
    Swal.fire(
      ...
      componentDidMount(){
        axios.get(`/api/requestgeneral/update/${this.props.match.params.id}`)
        .then(res => {
          this.setState({
              ...
              <Row>
                <Col>
                  ...
                  <Row form>
                    ...
                    <Button type="submit">Update Request Genaral</Button>
                  </Form>
                </Col>
    ...
    export default HocValidateUser(Update_RequestGeneral)
