...
var dateTime = date+' '+time;
    ...
    class Update_RequestIssuses extends Component {
      constructor (props) {
        super(props)
        this.state = {
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/requestissues/update/${this.props.match.params.id}`, insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
    ...
    Swal.fire(
      ...
      componentDidMount(){
        axios.get(`/api/requestissues/update/${this.props.match.params.id}`)
        .then(res => {
          this.setState({
    ...
    export default HocValidateUser(Update_RequestIssuses)
