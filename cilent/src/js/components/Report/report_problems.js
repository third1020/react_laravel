...
const style = {
 ...
 class Report_problems extends Component {
...
let formatted_endDate = this.state.endDate.getFullYear() + "-"
   ...
   for (let i = 0; i < this.state.getrequest.length; i++) {
     ...
     for(let i = 0; i < reportfilter.length; i++){
       ...
       console.log(reportfilter.problems_status);

       if(reportfilter[i].problems_status == "4"){

         access.push(reportfilter);

       }else if(reportfilter[i].problems_status == "3"){

         confirm.push(reportfilter);

       }else if(reportfilter[i].problems_status == "2"){

         workaround.push(reportfilter);

       }else if(reportfilter[i].problems_status == "1"){
 ...
 componentWillMount () {
   axios.get('/api/queryproblems').then(response => {
     this.setState({
...
Report_problems.propTypes = {
  id: PropTypes.number,

};

export default Report_problems
