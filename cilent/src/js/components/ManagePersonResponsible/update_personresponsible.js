...
let container;
    ...
    class Update_PersonResponsible extends Component {
      constructor (props) {
        super(props)
        this.state = {
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/personresponsible/update/${this.props.match.params.id}`, insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
    ...
    export default HocValidateUser(Update_PersonResponsible)
