...
export default class SelectUpdateForm extends Component {
    render() {
        return (

          <div>

          { this.props.ChooseUpdateForm == "user" ? (<Update_user id={this.props.id} updateurl={this.props.updateurl}/>) :null }
