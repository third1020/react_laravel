    ...
    customConfirm = (next, dropRowKeys) => {
        ...
        return swalWithBootstrapButtons
            ...
            .then(result => {
                if (result.value) {
                    axios
                        .delete(`${this.props.url}/delete_selected`, {
                            data: { foo: dropRowKeysStr }
                        })
                        .then(response => {
    ...
    priceFormatter = (cell, row) => {
        return (
            <div>
                ...
                {sessionStorage.getItem(`${this.props.manage}Delete`) ==
                true ? (
                    <button
                                            ...
                                            (colum, idx) => {
                                                if (colum == 'id') {
                                                    ...
                                                    if (
                                                        ...
                                                        sessionStorage.getItem(
                                                            `${this.props.manage}Edit`
                                                        ) == 1 ||
                                                        sessionStorage.getItem(
                                                            `${this.props.manage}Delete`
                                                        ) == 1
                                                    ) {
                                                        return (
                                                            <TableHeaderColumn
