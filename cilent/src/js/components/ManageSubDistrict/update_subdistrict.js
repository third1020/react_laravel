...
class Update_SubDistrict extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleCreate(event) {
        ...
        axios
            .put(
                `/api/district/update/${this.props.match.params.id}`,
                insertdata
            )
            .then(response => {
    ...
    componentDidMount() {
        ...
        axios
            .get(`/api/district/update/${this.props.match.params.id}`)
            .then(res => {
                this.setState({
...
export default HocValidateUser(Update_SubDistrict);
