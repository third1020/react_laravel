...
detail: detail
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/message/update/${this.props.match.params.id}`, insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
    ...
    Swal.fire(
      ...
      componentDidMount(){
        ...
        axios.get(`/api/message/update/${this.props.match.params.id}`).then(res => {
          this.setState({

            client_id : this.props.client_id,
            tital  : res.data.user.tital,
                ...
                <Col>
                  ...
                  <Row form>
                    ...
                    <Col md="12" className="form-group">
                      ...
                      id='tital'
                      name='tital'
                      className={`form-control ${this.hasErrorFor('tital') ? 'is-invalid' : ''}`}
    ...
    export default HocValidateUser(Update_Message)
