...
class View_SettingNews extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleCreate(event) {
        ...
        axios
            .put(
                `/api/settingnews/update/${this.props.match.params.id}`,
                insertdata
            )
            .then(response => {
    ...
    componentDidMount() {
        axios
            .get(`/api/settingnews/update/${this.props.match.params.id}`)
            .then(res => {
                this.setState({
...
export default HocValidateUser(View_SettingNews);
