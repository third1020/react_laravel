...
let container;
    ...
    class Add_SettingNews extends Component {
      constructor (props) {
        super(props)
        this.state = {
      ...
      handleCreate (event) {
        ...
        axios.post('/api/settingnews/store', insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
              ...
              <Row>
                <Col>
                  ...
                  <Row form>
                    ...
                    <Button type="submit">Create Setting News</Button>
                  </Form>
                </Col>
    ...
    export default HocValidateUser(Add_SettingNews)
