...
import HocValidateUser from "../../../HocValidateUser";
    ...
    class View_PostalCode extends Component {
      constructor (props) {
        super(props)
        this.state = {
          code  : '',
      ...
      handleCreate (event) {
        ...
        axios.put(`/api/postalcode/update/${this.props.match.params.id}`, insertdata)
  .then(response => {
    Swal.fire(
        'Successfully',
  ...
  .catch(error => {
    ...
    Swal.fire(
      ...
      componentDidMount(){
        ...
        axios.get(`/api/postalcode/update/${this.props.match.params.id}`).then(res => {
          this.setState({
                ...
                <Col>
                  ...
                  <Row form>
                    ...
                    <Col md="12" className="form-group">
                      ...
                      <label htmlFor="feEmailAddress">PostalCode</label>
                      <FormInput
                      id='code'
                      name='code'
                  ...
                  {this.renderErrorFor('district_id')}
                    ...
                    <Col md="6" className="form-group">
                      ...
                      <FormSelect
                         ...
                         {getsubdistrict.map((getsubdistrict,idx) => (
                            <option key={idx} value={getsubdistrict.id}>{getsubdistrict.name}</option>
                          ))}
                      </FormSelect>
    ...
    export default HocValidateUser(View_PostalCode)
